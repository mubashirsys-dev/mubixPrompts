...
export const features: Feature[] = [
  ...
  { id: "resume-upload", name: "Resume & CV Ingestion", description: "Upload a PDF/TXT resume to dynamically populate the site content", complexity: "medium", recommended: true, category: "advanced" },
  { id: "api-docs", name: "Interactive API Docs", description: "Generate beautiful API endpoint documentation and sandboxes", complexity: "medium", recommended: true, category: "advanced" },
  { id: "github-integration", name: "GitHub Integration", description: "Pull repositories, contributions, and commits directly into the UI", complexity: "easy", recommended: true, category: "advanced" },
  { id: "waitlist", name: "Waitlist Signup", description: "Capture interest before launch with automated queue numbers", complexity: "easy", recommended: true, category: "advanced" },
];
